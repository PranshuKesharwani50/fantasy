     ...
     // appBar: AppBar(title: Text('Wallet')),
      body:  Stack(
          ...
          children: [
            ...
            Positioned(top: 100,height:200,width: 350,
                child: Container(decoration: BoxDecoration(
                    boxShadow: const [
                      BoxShadow(
                        color: Colors.black26,
                        blurRadius: 4,
                        offset: Offset(1,1),spreadRadius: -5
                         // Shadow position
                      ),
                    ]
                ),
                ...
                child: Row(
                  children: [
                    Padding(
                      ...
                      child: Image.asset(coin,height: 70,width: 70,),
                    ),
                    Column(
                      children: const [
                        Padding(
                        ...
                        Padding(
                          padding: EdgeInsets.only(bottom: 10,right: 65,top: 5),
                          child: Text('Rs 250.00',style: TextStyle(
                              fontSize: 20,
                              fontFamily: font,
                              color: Colors.white)),
                        )
                              ...
                              Card(
                                ...
                                child: Column(
                                  children: [
                                    Padding(
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                               Padding(
                                                 padding: const EdgeInsets.only(left: 10,),
                                                 child: Image.asset(pinkcolor,height: 40,),
                                               ),
                                                Padding(
                                    ...
                                    Padding(
                                      padding: const EdgeInsets.only(bottom: 20,top: 15,right: 30),
                                      child: Column(
                                        children: [
                                          Padding(
                                            padding: const EdgeInsets.only(bottom: 5,right: 40,),
                                            child: Text('Your Winnings',style: TextStyle(
                                                fontSize: 13,
                                                fontFamily: font,
                                                color: Colors.black),),
                                          ),
                                          Padding(
                                            ...
                                            child: Text('My Match Winnings',style: TextStyle(
                                                fontSize: 13,
                                                fontFamily: font,
                                                color:Colors.grey)),
                                          ),
            ...
            Card(
              ...
              child: Column(
                children: [
                  ...
                  Padding(
                    padding: const EdgeInsets.only(bottom: 20,top: 15,right:50),
                    child: Column(
                      children: [
                        Padding(
                          padding: const EdgeInsets.only(bottom: 5,right: 25,),
                          child: Text('Deposited',style: TextStyle(
                              fontSize: 13,
                              fontFamily: font,
                              color: Colors.black),),
                        ),
                        Text('Money You Add',style: TextStyle(
                            fontSize: 13,
                            fontFamily: font,
                            color:Colors.grey)),
                      ],
                        ...
                        children: [
                          Row(
                            ...
                            children:[
                              ...
                              Padding(
                                padding: const EdgeInsets.only(left: 15),
                                child: Text('Cash Bonus',style: TextStyle(
                                    fontSize: 13,
                                    fontFamily: font,
                                    color:Colors.black)),
                              ),
                          ...
                          Padding(
                            ...
                            child: Row(
                              children: [
                                ...
                                Padding(
                                  padding: const EdgeInsets.all(8.0),
                                  child: Text('KYC & Verify Details',style: TextStyle(
                                      fontSize: 14,
                                      fontFamily: font,
                                      color:Colors.black)),
                                ),
                                Padding(
                                  ...
                                  child: IconButton(
                                      ...
                                      icon:ImageIcon(AssetImage(forward),size: 20,color: Colors.black26,)),
                                ),
            ...
            Positioned(top: 332,right: 197,child:
              Row(children: [ Image.asset(coin,height: 15),
              SizedBox(width: 5,),
              Text('Rs 0.00',style: TextStyle(
                  fontSize: 12,
                  fontFamily: font,
                  color: Colors.green,fontWeight: FontWeight.w700))])),
            Positioned(top: 332,right: 25,child:
            Row(children: [ Image.asset(coin,height: 15),
              SizedBox(width: 5,),
